...
execute as @e[sort=nearest,limit=1,tag=shifter,tag=brain] at @s run effect give @e[type=magma_cube,distance=..10,nbt={Size:1}] minecraft:slow_falling 20 5 true
