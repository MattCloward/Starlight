...
summon magma_cube ~-0.5 ~-0.5 ~-0.5 {Size:8,Tags:["shifter","brain","phase1"],Silent:1b,NoAI:1b,PersistenceRequired:1b,DeathLootTable:"",Attributes:[{Name:"generic.follow_range",Base:150.0}]}
