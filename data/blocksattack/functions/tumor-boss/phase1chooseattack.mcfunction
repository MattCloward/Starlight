...
execute if entity @s[scores={numSculklings=10..}] as @e[type=block_display,tag=eye_pupil,limit=1,sort=nearest] at @s positioned ~ ~-1 ~ run scoreboard players set @s priming 1
