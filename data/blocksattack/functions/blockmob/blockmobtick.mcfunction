...
execute as @e[type=magma_cube,tag=block_mob,nbt={NoAI:0b}] at @s if entity @p[limit=1,sort=nearest,distance=16..,gamemode=!spectator] run function blocksattack:freezeblockmob
